  ...
  it("returns one yearly value per simulation year", () => {
    ...
    expect(zeitreihe[0]).toEqual(
      expect.objectContaining({
        ...
        sparplanAusCashZuschuss: expect.any(Number),
        sparplanAusGewinnBrutto: expect.any(Number),
        sparplanAusGewinnSteuer: expect.any(Number),
        sparplanAusGewinnSoli: expect.any(Number),
        sparplanAusGewinnNetto: expect.any(Number),
        sparplanAusDarlehensZuzahlung: expect.any(Number),
        sparplanAbzugKonsum: expect.any(Number),
        entnahmenVorSteuern: expect.any(Number),
        etfVerkaufFuerGehalt: expect.any(Number),
        etfVerkaufFuerZinsen: expect.any(Number),
        etfVerkaufFuerSparplanDefizit: expect.any(Number),
        etfVerkaufFuerStillenGesellschafter: expect.any(Number),
        etfVerkaufFuerVorabpauschalesteuer: expect.any(Number),
        etfVerkaufFuerEtfVerkaufssteuer: expect.any(Number),
        etfVerkaufVerwendungszweckGesamt: expect.any(Number),
